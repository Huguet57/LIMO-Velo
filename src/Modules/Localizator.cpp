...
// class Localizator
    ...
    // private:
        ...
        void Localizator::init_IKFoM_state(const IMU& imu) {
            ...
            init_state.grav = S2(-Eigen::Vector3f (Config.initial_gravity.data()));
            init_state.bg = Eigen::Vector3d::Zero();
            init_state.offset_R_L_I = SO3(Eigen::Map<Eigen::Matrix3f>(Config.I_Rotation_L.data(), 3, 3));
            init_state.offset_T_L_I = Eigen::Vector3f(Config.I_Translation_L.data());
